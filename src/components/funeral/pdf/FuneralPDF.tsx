...
import { FUNERAL_STEPS } from "@/lib/funeral-steps";
...
export default function FuneralPDF({
  details,
  selections,
  cantorName,
  paymentAmount,
  ...
  const titleDisplay = details.deceasedName || "Funeral Liturgy Music Selections";
    ...
    <Document>
      <Page size="LETTER" style={s.page}>
        ...
        <View style={s.headerBar}>
          ...
          <Text style={s.title}>{titleDisplay}</Text>
          <Text style={s.subtitle}>In Loving Memory</Text>
        </View>

        {/* Details */}
        <View style={s.detailsSection}>
          <Text style={s.detailsTitle}>Service Details</Text>
          {details.deceasedName && (
            <View style={s.detailRow}>
              <Text style={s.detailLabel}>Deceased</Text>
              <Text style={s.detailValue}>{details.deceasedName}</Text>
            </View>
          )}
          {details.contactName && (
            <View style={s.detailRow}>
              <Text style={s.detailLabel}>Family Contact</Text>
              <Text style={s.detailValue}>{details.contactName}</Text>
            </View>
          )}
          {details.eventDate && (
            <View style={s.detailRow}>
        ...
        {/* Payment / Musician Info */}
        {(paymentAmount || musicianDetails) && (
          <View style={s.paymentSection}>
            <Text style={s.detailsTitle}>Musician Information</Text>
            {paymentAmount && (
              <View style={s.detailRow}>
            ...
            {musicianDetails && (
              <View style={s.detailRow}>
                ...
                <Text style={s.detailValue}>{musicianDetails}</Text>
              </View>
            )}
          </View>
        )}
